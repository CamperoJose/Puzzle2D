...
public class game2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttons[0][3] = findViewById(R.id.btD);
        buttons[1][0] = findViewById(R.id.btE);
        buttons[1][1] = findViewById(R.id.btF);
        buttons[1][2] = findViewById(R.id.btG);
        buttons[1][3] = findViewById(R.id.btH);
        buttons[2][0] = findViewById(R.id.btI);
        buttons[2][1] = findViewById(R.id.btJ);
        buttons[2][2] = findViewById(R.id.btK);
        buttons[2][3] = findViewById(R.id.btL);
        buttons[3][0] = findViewById(R.id.btM);
        buttons[3][1] = findViewById(R.id.btN);
        buttons[3][2] = findViewById(R.id.btO);
        buttons[3][3] = findViewById(R.id.btX);
        ...
        int[][] posiciones = {{0,0}, {0,1}, {0,2}, {0,3},{1,0}, {1,1}, {1,2}, {1,3},{2,0}, {2,1}, {2,2}, {2, 3},{3,0}, {3,1}, {3,2}, {3, 3}};

        for (int i = 0; i < 100; i++) {
            int pos1 = (int) (Math.random() * 16);
            int pos2 = (int) (Math.random() * 16);
    ...
    void alertaInstrucciones() {
        ...
        imageView.setImageResource(R.drawable.hint2);
    ...
    public void onClick(View v) {
        ...
        Button down = row < 3 ? buttons[row + 1][col] : null;
        Button left = col > 0 ? buttons[row][col - 1] : null;
        Button right = col < 3 ? buttons[row][col + 1] : null;
    ...
    private void updateEstado() {
        ...
        if(     buttons[0][0].getText().equals("A") &&
                ...
                buttons[0][3].getText().equals("D") &&
                buttons[1][0].getText().equals("E") &&
                buttons[1][1].getText().equals("F") &&
                buttons[1][2].getText().equals("G") &&
                buttons[1][3].getText().equals("H") &&
                buttons[2][0].getText().equals("I") &&
                buttons[2][1].getText().equals("J") &&
                buttons[2][2].getText().equals("K") &&
                buttons[2][3].getText().equals("L") &&
                buttons[3][0].getText().equals("M") &&
                buttons[3][1].getText().equals("N") &&
    ...
    void alertaVictoria1(){
        ...
        ale1.setMessage("Haz resuelto el puzzle en "+timeresolved(obtenerTiempoActual())+" y ganaste 12 puntos!");
        ale1.setCancelable(false);//ventana modal
        ale1.setPositiveButton("Volver", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                MainActivity.user1.RegistroPuntos(12);
    ...
    private void iniciarCronometro() {
        cronometro = new CountDownTimer(420000, 1000) {
    ...
    String timeresolved(String a){
        ...
        String b[]=a.split(":");
        int sec=420-(Integer.parseInt(b[0])*60+Integer.parseInt(b[1]));
        int min = sec/60;
        sec=sec-min*60;
        return min+":"+sec;
    }
