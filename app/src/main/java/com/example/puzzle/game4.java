...
public class game4 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void updateEstado() {
        ...
        if(     buttons[0][0].getText().equals("1") &&
                ...
                buttons[0][3].getText().equals("4") &&
                buttons[1][0].getText().equals("5") &&
                buttons[1][1].getText().equals("6") &&
                buttons[1][2].getText().equals("7") &&
                buttons[1][3].getText().equals("8") &&
                buttons[2][0].getText().equals("9") &&
                buttons[2][1].getText().equals("10") &&
                buttons[2][2].getText().equals("11") &&
                buttons[2][3].getText().equals("12") &&
                buttons[3][0].getText().equals("13") &&
                buttons[3][1].getText().equals("14") &&
    ...
    void alertaVictoria1(){
        ...
        ale1.setMessage("Haz resuelto el puzzle en "+timeresolved(obtenerTiempoActual())+" y ganaste 15 puntos!");
        ale1.setCancelable(false);//ventana modal
        ale1.setPositiveButton("Volver", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                MainActivity.user1.RegistroPuntos(15);
    ...
    private void iniciarCronometro() {
        cronometro = new CountDownTimer(540000, 1000) {
    ...
    String timeresolved(String a){
        ...
        String b[]=a.split(":");
        int sec=540-(Integer.parseInt(b[0])*60+Integer.parseInt(b[1]));
        int min = sec/60;
        sec=sec-min*60;
        return min+":"+sec;
    }
