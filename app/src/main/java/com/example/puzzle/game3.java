...
public class game3 extends AppCompatActivity implements View.OnClickListener {
    ...
    void alertaInstrucciones() {
        ...
        imageView.setImageResource(R.drawable.hint3);
    ...
    void alertaVictoria1(){
        ...
        ale1.setMessage("Haz resuelto el puzzle en "+timeresolved(obtenerTiempoActual())+" y ganaste 6 puntos!");
        ale1.setCancelable(false);//ventana modal
        ale1.setPositiveButton("Volver", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                MainActivity.user1.RegistroPuntos(6);
    ...
    private void iniciarCronometro() {
        cronometro = new CountDownTimer(360000, 1000) {
